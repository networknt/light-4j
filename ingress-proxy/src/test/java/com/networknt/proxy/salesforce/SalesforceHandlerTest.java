...
public class SalesforceHandlerTest {
    ...
    public static void setUp() throws Exception{
        if(server == null) {
            ...
            SalesforceHandler salesforceAuthHandler = new SalesforceHandler();
            salesforceAuthHandler.setNext(handler);
            handler = salesforceAuthHandler;
    ...
    public void testOneGetRequest() throws Exception {
        ...
        try {
            ClientRequest request = new ClientRequest().setPath("/salesforce").setMethod(Methods.GET);
