...
public class MrasHandlerTest {
    ...
    public static void setUp() throws Exception{
        if(server == null) {
            ...
            MrasHandler mrasHandler = new MrasHandler();
            mrasHandler.setNext(handler);
            handler = mrasHandler;
    ...
    static RoutingHandler getTestHandler() {
        return Handlers.routing()
                .add(Methods.POST, "/mras", exchange -> {
    ...
    public void testOneGetRequest() throws Exception {
        ...
        try {
            ClientRequest request = new ClientRequest().setPath("/mras").setMethod(Methods.GET);
