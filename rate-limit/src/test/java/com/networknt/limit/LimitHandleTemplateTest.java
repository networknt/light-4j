...
/**
 * Run the test against the limit-template.yml with a values.yml to replicate an issue
 * opened by one of our users.
 *
 * @author Steve Hu
 */
public class LimitHandleTemplateTest {

    static final Logger logger = LoggerFactory.getLogger(LimitHandlerTest.class);
    static final LimitConfig config = LimitConfig.load("limit-template");
    ...
    public static void setUp() throws Exception{
        if(server == null) {
            ...
            LimitHandler limitHandler = new LimitHandler("limit-template");
