...
components built in and uses a lot of CPU and memory. 
...
REST container Sprint Boot with embedded Tomcat.
...
Also, our own OAuth2 server built on top of Light-Java framework is very
...
also open sourced and can be found at [https://github.com/networknt/light-oauth2](https://github.com/networknt/light-oauth2)
