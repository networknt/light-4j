...
public class ConfigDefaultTest {
    ...
    public void testGetJsonMapConfig() throws Exception {
        ...
        Assertions.assertEquals("default config", configMap.get("value"));
        // case2: config with environment variable
        if (!OS.startsWith("windows")) {
            Assertions.assertEquals(System.getenv("HOME"), configMap.get("value1"));
        }
        // case3: escape from injecting environment variable
        Assertions.assertEquals("${ESCAPE}", configMap.get("value2"));
        // case4: override to map with centralized file
        Assertions.assertEquals("test", configMap.get("value3"));
        // case5: override to map with centralized file
        Assertions.assertEquals(Arrays.asList("element1", "element2"), configMap.get("value4"));
        // case6: override to map with centralized file
        Assertions.assertEquals(testMap, configMap.get("value5"));
        // case7: default value start with $ but not escape
        Assertions.assertEquals("$abc", configMap.get("value6"));
    }
    ...
    public void testGetJsonObjectConfig() throws Exception {
        ...
        // case1: regular config
        Assertions.assertEquals("default config", tc.getValue());
        // case2: config with environment variable
        if (!OS.startsWith("windows")) {
            Assertions.assertEquals(System.getenv("HOME"), tc.getValue1());
        }
        // case3: escape from injecting environment variable
        Assertions.assertEquals("${ESCAPE}", tc.getValue2());
        // case4: override to map with centralized file
        Assertions.assertEquals("test", tc.getValue3());
        // case5: override to map with centralized file
        Assertions.assertEquals(Arrays.asList("element1", "element2"), tc.getValue4());
        // case6: override to map with centralized file
        Assertions.assertEquals(testMap, tc.getValue5());
        // case7: default value start with $ but not escape
        Assertions.assertEquals("$abc", tc.getValue6());
    }
    ...
    public void testInjectionExclusionConfig() {
        ...
        Assertions.assertEquals("${TEST.string}", configMap.get("key"));
    }
    ...
    public void testObjectMapperZonedDateTime() throws Exception {
        ...
        Assertions.assertTrue(zonedDateTime2.equals(dm.getTime()));
    }
    */
    ...
    public void testObjectMapperLocalDateTime() throws Exception {
        ...
        Assertions.assertTrue(dm2.equals(dm.getTime()));
    }
    ...
    public void testObjectMapperLocalDate() throws Exception {
        ...
        System.out.println(dm2);
        Assertions.assertTrue(dm2.equals(dm.getDate()));
    }
}
