...
public class RouterHandler implements HttpHandler {
    ...
    private void buildProxy() {
        ...
        proxyHandler = ProxyHandler.builder()
                ...
                .setStreamResponseContentTypes(config.getStreamResponseContentTypes())
                .setStreamRequestAcceptTypes(config.getStreamRequestAcceptTypes())
                .setStreamPathPrefixes(config.getStreamPathPrefixes())
                .setStreamMaxRequestTime(config.getStreamMaxRequestTime())
                .setStreamIdleTimeout(config.getStreamIdleTimeout())
                .setStreamResponseHeaderOverwrite(config.getStreamResponseHeaderOverwrite())
